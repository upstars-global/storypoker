...
## Corpus Check
- 80 files · ~55,353 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 746 nodes · 995 edges · 49 communities (35 shown, 14 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `09e87f98`
...
Cohesion: 0.05
Nodes (46): presence, { status }, CompositeTypes, Constants, Database, DatabaseWithoutInternals, DefaultSchema, Enums (+38 more)
...
Cohesion: 0.14
Nodes (16): BUBBLE_COLORS, cardLabel, celebrate, celebrationParticles, chartsEl, emit, groups, props (+8 more)
...
Cohesion: 0.29
Nodes (6): AVATAR_STYLES, bottts, cache, dylan, miniavs, useDylanAvatar()
...
Cohesion: 0.67
Nodes (3): AvatarStyle, useProfilesStore, UserProfile

## Knowledge Gaps
- **485 isolated node(s):** `{ init }`, `emit`, `roomStore`, `playersStore`, `{ visiblePlayers }` (+480 more)
...
- **Why does `useAuthStore` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 7`, `Community 9`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `useProfilesStore` connect `Community 48` to `Community 0`, `Community 1`, `Community 2`, `Community 36`, `Community 7`, `Community 9`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `useCardLabel()` connect `Community 6` to `Community 8`, `Community 10`, `Community 36`?**
