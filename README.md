...
```zsh
# FRONTEND
npx skills add giuseppe-trisciuoglio/developer-kit -s tailwind-css-patterns -a codex -a claude-code -y
npx skills add anthropics/skills -s frontend-design -a codex -a claude-code -y
...
# META
npx skills add anthropics/claude-plugins-official -s claude-md-improver -a codex -a claude-code -y

# SUPABASE
npx skills add supabase/agent-skills -s supabase -a codex -a claude-code -y
